...
class FlipperGame(Widget):
    ...
    rightKicker = Kicker("rightKicker",11,GPA2_L_OND5_S25_RUBBERBAND_KICKER_RECHTS_BENEDEN_BOVENSTE, GPA3_L_OND6_S25_RUBBERBAND_KICKER_RECHTS_BENEDEN_ONDERSTE, GPA4_L_OND7_S103_RUBBERBAND_KICKER_RECHTS_BENEDEN_SOLENOID)
    GPIO.setup(rightKicker.coilPin, GPIO.OUT,initial=LOW)

    leftKicker = Kicker("leftKicker",5,GPB3_L_BVN7_S105_RUBBERBAND_KICKER_LINKS_BENEDEN_BOVENSTE_SOLENOID,GPB4_L_BVN6_S104_RUBBERBAND_KICKER_LINKS_BENEDEN_ONDERSTE,GPA4_L_OND7_S103_RUBBERBAND_KICKER_RECHTS_BENEDEN_SOLENOID)
    GPIO.setup(leftKicker.coilPin, GPIO.OUT,initial=LOW)

    lowerLeftBumper = Bumper("lowerLeftBumper",26,GPB3_L_BVN1_S17_BUMPER_PLASTIC_LINKS_BENEDEN,GPA4_L_OND1_S17_BUMPER_METAAL_LINKS_BENEDEN)
    GPIO.setup(lowerLeftBumper.coilPin, GPIO.OUT,initial=LOW)

    topLeftBumper = Bumper("topLeftBumper",13,,GPB0_L_BVN4_S15_BUMPER_PLASTIC_LINKS_BOVEN, GPA7_L_OND4_S15_BUMPER_METAAL_LINKS_BOVEN)
    GPIO.setup(topLeftBumper.coilPin, GPIO.OUT,initial=LOW)

    lowerRightBumper = Bumper("lowerRightBumper",19,GPB1_L_BVN3_S6_BUMPER_PLASTIC_RECHTS_BENEDEN,GPA6_L_OND3_S6_BUMPER_METAAL_RECHTS_BENEDEN)
    ...
    scrubMode = Scrubmode("Scrubmode",10,9,GPA5_L_OND8_S14_GELE_TARGET_LINKS_BOVEN, GPA6_L_OND9_S18_GELE_TARGET_LINKS_MIDDEN, GPA7_L_OND10_S20_GELE_TARGET_LINKS_BENEDEN,GPB0_L_BVN10_S1_GELE_TARGET_RECHTS_BENEDEN,GPB1_L_BVN9_S3_GELE_TARGET_RECHTS_MIDDEN,GPB2_L_BVN8_S7_GELE_TARGET_RECHTS_BOVEN,GPB5_R_BVN3_S101_RODE_KNOP_SCROBMODE)
